        ...
        {isOpen && (
          ...
          >
            ...
            <motion.button
              ...
              className="flex items-center gap-3 bg-[#25D366] text-white px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-shadow whitespace-nowrap"
            >
              <WhatsAppIcon />
            ...
            <motion.button
              ...
              className="flex items-center gap-3 bg-[#0084FF] text-white px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-shadow whitespace-nowrap"
            >
              <FacebookIcon />
